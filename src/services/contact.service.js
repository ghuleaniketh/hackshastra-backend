...
// ===== TEMP DISABLED: Contact in-memory OTP store & cleanup (commented out on 2026-09-08) =====
...
//   }
// }, 5 * 60 * 1000);
// ===== END TEMP DISABLED: Contact in-memory OTP store & cleanup =====

/**
 * Generate and email 6-digit OTP for email verification
 */
export const requestContactOtp = async ({ email }) => {
  // ===== TEMP DISABLED: Contact OTP generation & dispatch (commented out on 2026-09-08) =====
  ...
  //   throw err;
  // }
  // ===== END TEMP DISABLED: Contact OTP generation & dispatch =====
...
export const submitContactRequest = async (contactData) => {
  ...
  // ===== TEMP DISABLED: Verification token check (commented out on 2026-09-08) =====
  ...
  //   throw err;
  // }
  // ===== END TEMP DISABLED: Verification token check =====
  ...
  // ===== TEMP DISABLED: Admin contact notification email (commented out on 2026-09-08) =====
  ...
  // });
  // ===== END TEMP DISABLED: Admin contact notification email =====
